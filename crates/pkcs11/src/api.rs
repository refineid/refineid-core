...
use crate::pin::{PinBytes, PinRoleError};
use refineid_auth::{PinRetryRisk, PinStatus};
...
use crate::ck::{
    ...
    CKF_USER_PIN_INITIALIZED, CKF_USER_PIN_LOCKED, CKF_WRITE_PROTECTED, CKR_ARGUMENTS_BAD,
...
const TOKEN_FIRMWARE_VERSION: CkVersion = CkVersion {
    major: version_component(env!("CARGO_PKG_VERSION_MINOR")),
    minor: version_component(env!("CARGO_PKG_VERSION_PATCH")),
};
